Proyecto creado en Kotlin con arquitectura Clean Architecture para tener separadas las capas y permitir una mejor escalabilidad del proyecto y hacerlo más fácil de mantener.
